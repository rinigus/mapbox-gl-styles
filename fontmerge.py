...
import re, argparse, os, glob, sqlite3, tempfile, shutil, collections
import glyphs_pb2 as glyphs
...
parser.add_argument('--fontname', type=str, required=True, help='Font name for the merged fonts')
